...
const PROTECTED_FILES: readonly string[] = Object.freeze([
  ...
  "scripts/Test-PythonBaseOnlyRuntimeAcl.ps1",
  "scripts/Test-PythonStagingOnlyRuntimeAcl.ps1",
  ...
  "scripts/TradingLabBuildVenvGate.ps1",
  "scripts/TradingLabPromoteVenvGate.ps1",
